...
with python and docker, [decwar/merely-players install.py](https://gitlab.com/decwar/merely-players/-/blob/main/install.py) takes care of everything and contains it's own simple instructions.

# folder structure

- [project utexas log](project-utexas-log.md)
- hlp, the currently known help files, with important differences
